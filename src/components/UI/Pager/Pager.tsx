...
import { getColumnToBackendTerm } from '../../../common/constants';
        ...
        return (
          ...
          >
            {i !== columnNames.length - 1 ? (
              <TableSortLabel
                active={getColumnToBackendTerm(listName, name) === tableVals.sortCol}
                direction={tableVals.sortDirection}
                onClick={() => {
                  if (getColumnToBackendTerm(listName, name) !== tableVals.sortCol) {
